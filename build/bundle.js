...
var sliceBuffer = __webpack_require__(88);
...
var calculator_ts_1 = __webpack_require__(73);
var store_calculator = redux_1.createStore(calculator_ts_1["default"], {
    fetching: false,
    fetched: false,
    error: null,
    value: ""
});
exports["default"] = store_calculator;
...
var Backoff = __webpack_require__(98);
...
var websocket = __webpack_require__(95);
...
var Calculator_tsx_1 = __webpack_require__(57);
__webpack_require__(99);
ReactDOM.render(React.createElement(Calculator_tsx_1["default"], null), document.querySelector("#root"));
...
var calculator_1 = __webpack_require__(26);
var React = __webpack_require__(5);
var ACT = const_1["default"].ACT;
var characters = [
    ["C", "+", "7", "4", "1", "."],
    ["CE", "-", "8", "5", "2", "0"],
    ["(", "*", "9", "6", "3", "00"],
...
var Calculator = (function (_super) {
    ...
    Calculator.prototype.updateExpression = function (character) {
        if (calculator_1["default"].getState().fetching) {
            return void 0;
        }
        if (character === "=") {
            calculator_1["default"].dispatch({
                type: ACT.FETCHING,
    ...
    Calculator.prototype.componentWillMount = function () {
        var _this = this;
        calculator_1["default"].subscribe(function () {
            var state = calculator_1["default"].getState();
            if (state.fetching) {
                return void 0;
            }
            else if (state.fetched) {
                _this.refs.expression.value = state.value;
            }
            else if (state.error) {
                _this.refs.expression.value = state.error;
            }
        });
    };
    Calculator.filter_input = function (event) {
        event.target.value = event.target.value.replace(/[^0-9()+\-*\/^%]/g, "");
    };
    Calculator.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: "calculator" },
            React.createElement("div", { className: "input_wrapper" },
                React.createElement("input", { type: "text", ref: "expression", onInput: Calculator.filter_input })),
            React.createElement("div", { className: "buttons" }, characters.map(function (row, index) {
                return React.createElement("div", { className: "column", key: index }, row.map(function (character, index) {
                    return React.createElement("div", { className: "button", onClick: _this.updateExpression.bind(_this, character), key: index }, character);
                }));
            }))));
    };
    return Calculator;
...
exports.__esModule = true;
var const_ts_1 = __webpack_require__(14);
var socket_ts_1 = __webpack_require__(74);
var ACT = const_ts_1["default"].ACT;
function reducer_calculator(state, action) {
    ...
    switch (action.type) {
        case ACT.FETCHING: {
            state = __assign({}, state, { fetching: true });
            socket_ts_1["default"].send(action.payload);
            break;
        }
        case ACT.FETCHED: {
            state = __assign({}, state, { fetched: true, fetching: false, value: action.payload });
            break;
        }
        case ACT.ERROR: {
            state = __assign({}, state, { fetching: false, fetched: false, error: action.payload });
            break;
        }
        default: {
            if (typeof action.type !== "string" || action.type.indexOf("@@redux") === -1) {
...
exports["default"] = reducer_calculator;
...
var const_1 = __webpack_require__(14);
var calculator_1 = __webpack_require__(26);
var socket_io_client_1 = __webpack_require__(75);
var ACT = const_1["default"].ACT, socket = socket_io_client_1.connect("ws://localhost:4200");
...
if (typeof window === 'undefined') {
  try {
    NodeWebSocket = __webpack_require__(96);
  } catch (e) { }
}
